  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-8 animate-pulse">
        <div className="h-4 w-16 rounded-lg bg-deep-slate/5" />
        <div className="mt-4 h-8 w-40 rounded-lg bg-deep-slate/5" />
        <div className="mt-2 h-4 w-28 rounded-lg bg-deep-slate/5" />
      </div>
