export default function HomeLoading() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      {/* Search bar skeleton */}
      <div className="mb-10 h-11 w-full animate-pulse rounded-lg bg-deep-slate/5" />

      {/* Featured post hero skeleton */}
      <div className="mb-14 animate-pulse">
        <div className="aspect-video w-full rounded-xl bg-deep-slate/5" />
        <div className="mt-5 flex gap-2">
          <div className="h-6 w-16 rounded-full bg-deep-slate/5" />
          <div className="h-6 w-20 rounded-full bg-deep-slate/5" />
        </div>
        <div className="mt-3 h-9 w-3/4 rounded-lg bg-deep-slate/5" />
        <div className="mt-2 h-5 w-1/2 rounded-lg bg-deep-slate/5" />
        <div className="mt-3 h-4 w-32 rounded-lg bg-deep-slate/5" />
      </div>

      {/* Accent divider */}
      <div className="mb-10 h-px w-full bg-deep-slate/5" />
