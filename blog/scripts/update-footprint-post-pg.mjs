...
This is the core micro-mechanic. Once it clicks, every chart you have ever stared at suddenly has a soundtrack.`,
  },
  {
    ...
    body: `Below is the live order book, footprint, and delta meter you can drive yourself. Open it in a new tab and fire market orders into the book, run the trend bar, the absorption sequence, and the chop bar. Watch the order book deplete, the footprint cells light up, and delta react in real time.

[**Open the interactive orderflow simulator →**](/demos/orderflow.html)

Run the demos in this order for the cleanest learning curve:
